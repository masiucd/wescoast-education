...
const teachers = [
  teacher({ id: 1, firstName: "mark", lastName: "smith", email: "mark@io.com", age: 37, type: "t" }),
  teacher({ id: 2, firstName: "george", lastName: "pierre", email: "pierre@io.com", age: 48, type: "t" }),
